  ...
  public BaseRoom generate(Coord at, List<Direction> entrances) {
    ...
    for (Direction dir : Direction.CARDINAL) {
      ...
      for (Direction orth : dir.orthogonals()) {
        ...
        primaryStairBrush().setUpsideDown(true).setFacing(orth.reverse()).stroke(worldEditor, cursor);
        ...
        primaryStairBrush().setUpsideDown(true).setFacing(orth).stroke(worldEditor, cursor);
